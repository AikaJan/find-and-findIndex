...
The function should return the first object with 
the key of username that matches the string passed 
...
function removeUser(usersArray, username) {
  for (let i = 0; i < usersArray.length; i++) {
    if (usersArray[i].username === username) {
      const removedUser = usersArray.splice(i, 1)[0];
      return removedUser;
    }
  }
  return undefined;
...
console.log(removeUser(user, 'akagen')); 
console.log(user); 
console.log(removeUser(user, 'akagen')); 
